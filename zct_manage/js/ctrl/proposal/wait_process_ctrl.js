...
define(["app", 'echarts', 'api/proposal_api','services/myalert/myalert','services/setting','services/common'], function (myapp, echarts) {
    myapp.controller('wait_process_ctrl', ['$scope','$rootScope', 'proposal_api','myalert','$state','setting','common',function (s,$rootScope, proposal_api,myalert,$state,setting,common) {
        $rootScope.istick = 'wait';
        //待审批
        s.getType = 1;
