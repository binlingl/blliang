/**
 * Created by JackYin on 2016/7/15.
 */
!function (e) {
    ...
    return function e(n, t, r) {
        ...
        1: [function (e, n, t) {
            ...
            var r = e('../utils');
            n.exports = {
                JDPAY_WAP_URL: 'https://m.jdpay.com/wepay/web/pay', handleCharge: function (e) {
                    var n = e.credential[e.channel];
                    r.formSubmit(this.JDPAY_WAP_URL, 'post', n)
                }
            }
            ...
            o.store = function (e) {
                ...
                if ('undefined' != typeof localStorage) {
                    ...
                    if (!('undefined' == typeof localStorage.PPP_ONE_STATS || localStorage.PPP_ONE_STATS.split(e.seperator).length < e.limit))try {
                        for (var n = [], t = localStorage.PPP_ONE_STATS.split(e.seperator), a = i(t.join('&')), o = 0; o < t.length; o++)n.push({
                            app_id: c(t[o], 'app_id'),
                            channel: c(t[o], 'channel'),
                            ch_id: c(t[o], 'ch_id'),
                            host: c(t[o], 'host'),
                            time: c(t[o], 'time'),
                            type: c(t[o], 'type'),
                            user_agent: c(t[o], 'user_agent'),
                            puid: c(t[o], 'puid')
                        });
                        r.request(e.report_url, 'POST', n, function (e, n) {
                            200 == n && localStorage.removeItem('PPP_ONE_STATS')
                        }, void 0, {'X-Pingpp-Report-Token': a})
                    } catch (l) {
                    }
                }
            }, o.report = function (e) {
            ...
            n.exports = {
                SRC_URL: 'https://cookie.pingxx.com', init: function () {
                    ...
                    if ('undefined' != typeof window && 'undefined' != typeof localStorage) {
                        var e;
                        if ('undefined' == typeof localStorage.pingpp_uid ? (e = a.randomString(), localStorage.pingpp_uid = e) : e = localStorage.pingpp_uid, r.puid = e, !document.getElementById('p_analyse_iframe')) {
            ...
            var r = {}.hasOwnProperty, a = n.exports = {
                stringifyData: function (e, n, t) {
                    ...
                    if ('function' != typeof XMLHttpRequest)return void console.log('Function XMLHttpRequest is undefined.');
